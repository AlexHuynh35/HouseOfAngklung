...
export default function SaveTheDate() {
  return (
    <div className="relative pt-3 w-full h-full flex flex-row justify-center bg-[url('/media/general/savethedate.jpg')] bg-cover">
      <div className="w-full xl:w-1/2 flex flex-col justify-center">
        <h2 className="w-80 text-4xl md:w-150 md:text-6xl font-bold mb-5 pl-6 text-center text-white">
          SAVE THE DATE
        </h2>
        <h2 className="w-80 text-xl md:w-150 md:text-3xl font-bold mb-8 p-3 text-center text-white bg-orange-600 rounded-r-full">
          April 29th to May 10th
        </h2>
        <h2 className="w-80 text-md md:w-150 md:text-xl font-bold mb-2 pl-6 text-center text-balance text-white">
